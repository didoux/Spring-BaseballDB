...
/**
 * The primary key class for the fieldingof database table.
 * 
 */
@Embeddable
public class FieldingofPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FieldingofPK)) {
			return false;
		}
		FieldingofPK castOther = (FieldingofPK)other;
		return 
