...
/**
 * The primary key class for the awardssharemanagers database table.
 * 
 */
@Embeddable
public class AwardssharemanagerPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AwardssharemanagerPK)) {
			return false;
		}
		AwardssharemanagerPK castOther = (AwardssharemanagerPK)other;
		return 
